...
class Interactions:
    ...
    def __init__(self):
        ...
        SECRET_PATH = "user_abdallah/data/rules2"
        ...
        try:
            ...
            # Read secret from Vault using the token
        ...
        self.CRMURL = 'https://app.opexpert.com/custom/service/v4_1_custom/rest.php'
    ...
    def getIntegrationWithID(self, reportID = '', params=''):
        if self.sessionID:
            ...
            #     'session': self.sessionID, 
            #     'report_id': reportID, 
            #     'UserInputParams': base64.b64encode(params.encode())
            # }
            try:
    ...
    def getReport(yamlFile,emailConfig): 
        command = f"python3 /home/rundeck/projects/RulesInterpreterApp/getAPIReport.py {yamlFile} \"{emailConfig}\""
        os.system(command)
